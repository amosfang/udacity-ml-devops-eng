...
5. feature_importance_plot()
6. train_models()

Author name: Amos Fang
Date: 2023/04/24
"""
...
def test_encoder_helper(import_data, encoder_helper, cat_columns):
    ...
    try:
        ...
        try:
            ...
            logging.error(
                "Testing df : df should have 10127 rows and 28 columns."
        ...
        try:
            ...
            logging.error(
                "Testing import_data: The file doesn't not have the Churn target column")
            raise err
    except FileNotFoundError as err:
        logging.error("Testing import_eda: The file wasn't found")
        raise err
...
def test_perform_feature_engineering(import_data, perform_feature_engineering):
    ...
    try:
        ...
        try:
            ...
            logging.error(
                "Testing of columns in X_train and X_test: Missing columns in X data")
            raise err
